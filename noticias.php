...
<body>
    ...
    <body>
            ...
            <div class="w3_navigation w3_navigation2">
                 ...
                 <div class="main-2" style="background-image:url(images/Noticiasbanner.png); background-repeat: no-repeat;background-size:  cover;">
                
                <div class="banner">
                    <!--Slider-->
                    <div class="slider-info slide-altura" >
								<h3>Noticias</h3>
							</div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="bottom-socila-icons">
                    <ul class="top-links two">
                        <li>
                            <a href="https://www.facebook.com/ArrendamosJV/" target="_blank">
