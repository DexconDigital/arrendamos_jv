     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">ArrendamosJV</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="update_estadisticas.php" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">Numero de Clientes</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="clientes" id="clientes" value="<?php echo $res[1]; ?>"  required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Propiedades en Venta</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="venta" id="venta" value="<?php echo $res[2]; ?>"  required>
                        </div>
                    </div>
                    <div class="bs-example" data-example-id="form-validation-states">
                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Propiedades en Arriendo</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="arriendo" id="arriendo" value="<?php echo $res[3]; ?>"  required>
                        </div>
                        
                    </div>
                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Experiencia</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="experiencia" id="experiencia" value="<?php echo $res[4]; ?>"  required>
                        </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button class="btn-success btn">Actualizar datos</button>
