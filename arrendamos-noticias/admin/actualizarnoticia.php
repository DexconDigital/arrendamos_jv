    ...
    <div id="wrapper">
        ...
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><em>Arrendamos</em>JV</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <div class="tab-pane active" id="horizontal-form">
                        <form class="form-horizontal" method="post" action="update2.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="noticia" id="noticia" class="form-control1"><?php echo $res[5]; ?></textarea>
                                </div>
                            </div>
                            <div class="bs-example" data-example-id="form-validation-states">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="">Archivo Actual <?php echo $res[4];?></label>
                                    <input type="file" name="archivo" id="archivo" value="<?php echo $res[4];?>" accept="application/pdf">
                                </div>
